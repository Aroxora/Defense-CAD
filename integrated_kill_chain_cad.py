...
CHINESE_INTEGRATED_KILL_CHAIN.md using pretrained contractor models.
...
class IntegratedKillChainCAD:
    ...
    def generate_comprehensive_report(self) -> str:
        ...
        report.append("Framework: Pretrained contractor models (AVIC, CASIC, CASC)")
