...
class TestPoint3D:
    ...
    def test_creation(self):
        """Test point creation"""
        from osint_cad.geometry.cad_geometry import Point3D
...
class TestVector3D:
    ...
    def test_magnitude(self):
        ...
        from osint_cad.geometry.cad_geometry import Vector3D
        v = Vector3D(3, 4, 0)
...
class TestTriangle:
    ...
    def test_area_right_triangle(self):
        ...
        from osint_cad.geometry.cad_geometry import Point3D, Triangle
        tri = Triangle(
            Point3D(0, 0, 0),
            Point3D(1, 0, 0),
            Point3D(0, 1, 0)
...
class TestOgiveNose:
    ...
    def test_ogive_creation(self):
        ...
        from osint_cad.geometry.cad_geometry import OgiveNose
...
class TestSearsHaackBody:
    ...
    def test_sears_haack_creation(self):
        ...
        from osint_cad.geometry.cad_geometry import SearsHaackBody
...
class TestMissileCADModel:
    ...
    def test_aim120_model(self):
        """Test AIM-120 model"""
        from osint_cad.geometry.cad_geometry import create_aim120_cad_model
...
class TestPhysicalOpticsRCS:
    ...
    def test_rcs_calculator_creation(self):
        ...
        from osint_cad.geometry.cad_geometry import CylindricalSection
        from osint_cad.geometry.cad_rcs_calculator import PhysicalOpticsRCSCalculator, MaterialProperties
    ...
    def test_rcs_sweep(self):
        ...
        from osint_cad.geometry.cad_geometry import create_pl15_cad_model
        from osint_cad.geometry.cad_rcs_calculator import CADRCSIntegrator
    ...
    def test_material_properties(self):
        ...
        from osint_cad.geometry.cad_rcs_calculator import MaterialProperties, MaterialType
...
class TestCADIntegration:
    ...
    def test_comparison_framework(self):
        ...
        from osint_cad.geometry.cad_rcs_calculator import RCSComparisonFramework
...
class TestVisualization:
    ...
    def test_trajectory_generation(self):
        ...
        from osint_cad.geometry.cad_visualization import TrajectoryGenerator, Point3D
    ...
    def test_platform_state(self):
        ...
        from osint_cad.geometry.cad_visualization import PlatformState, PlatformSymbol, Point3D, Vector3D
...
class TestNumericalStability:
    ...
    def test_zero_velocity_aspect(self):
        ...
        from osint_cad.geometry.cad_geometry import Point3D
        from osint_cad.physics.rcs_models import calculate_aspect_angles
