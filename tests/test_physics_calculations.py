...
class TestRCSConversions:
    ...
    def test_linear_to_dbsm_typical_values(self):
        ...
        from osint_cad.physics.rcs_models import rcs_linear_to_dbsm
    ...
    def test_dbsm_to_linear_typical_values(self):
        ...
        from osint_cad.physics.rcs_models import rcs_dbsm_to_linear
    ...
    def test_roundtrip_conversion(self):
        ...
        from osint_cad.physics.rcs_models import rcs_linear_to_dbsm, rcs_dbsm_to_linear
...
class TestIntegration:
    ...
    def test_detection_range_matches_rcs_model(self):
        ...
        from osint_cad.physics.rcs_models import calculate_detection_range, J20RCSModel, F35ARCSModel
