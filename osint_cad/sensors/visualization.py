...
from osint_cad.sensors.geolocation_network import EmitterTrack, NetworkLink, PlatformState
...
if __name__ == "__main__":
    ...
    from osint_cad.sensors.geolocation_network import EmitterTrack
    tracks = {
    ...
    # Create links
    from osint_cad.sensors.geolocation_network import NetworkLink
    links = [
